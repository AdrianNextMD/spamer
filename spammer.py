...
8888888888888888888888888
8888    FSystem88    8888
8888   SMS Pavlik   8888
8888   v.6 (final)   8888
8888888888888888888888888
8888888888888888888888888'''+Style.RESET_ALL)
		print(Style.RESET_ALL)
		parser = argparse.ArgumentParser(prog='spymer', description="Fucking shit by Pavlik. Daca ceva nu toate servisurile locraza in Moldova si in Romania!",epilog='E-mailul meu - adriano99pavaleanu@gmail.com')
		parser.add_argument('phonenum', metavar='phone', help='Numarul la victima (exemlu: 37362085989)')
